...
export default function Form(props) {
  ...
  const onSubmitHandler = (event) => {
    ...
    setFormValidation({
      ...getFormValidation,
      productName: getForm.productName ? false : true,
    ...
    <div>
      <form>
        ...
        <input
          ...
          name="productName"
        />
        {getFormValidation.productName && (
          <div style={{ fontSize: '12px', color: 'red', padding: '20px' }}>
        ...
        <input
          ...
          name="productColor"
        />
        {getFormValidation.productColor && (
        ...
        <input
          ...
          name="productAmount"
        />
        {getFormValidation.productAmount && (
          <div style={{ fontSize: '12px', color: 'red' }}>
